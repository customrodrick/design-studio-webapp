const PortfolioSection = () => {
    return (
        <section id="portfolio" className="py-20 bg-bg-secondary">
             <h2 className="text-4xl font-bold mb-4 text-accent-biege container mx-auto px-4 flex flex-row gap-2 items-center">
  About <span className="text-sky-600">Our Innovation Hub</span>
</h2>
            ...
            <div className="container mt-5 mx-auto px-4 flex flex-col md:flex-row gap-16 items-center">
                        
                        <ul className="text-text-secondary mb-6 list-none list-inside text-base space-y-2">
